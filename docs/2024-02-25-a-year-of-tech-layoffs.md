...
1. The end of the <abbr title="Zero Interest Rate Policy">ZIRP</abbr> era, higher interest rates means investors demand profitability (instead of growth) from portfolio companies.
...
[^5]: [The Alphabet Workers Union](https://www.alphabetworkersunion.org/) is a good counter-example.
